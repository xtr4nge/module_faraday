...
// FARADAY ADD HOST
if (sizeof($api) == 4 and $api[1] == "faraday" and $api[2] == "host") # api=/faraday/host/IP|MAC|NAME
{
	echo $ws->createHostAndInterface($api[3]);
}

// FARADAY ADD VULN
if (sizeof($api) == 4 and $api[1] == "faraday" and $api[2] == "vuln") # api=/faraday/vuln/IP|NAME|VULN
{
	echo $ws->createAndAddVulnToHost($api[3]);
}
